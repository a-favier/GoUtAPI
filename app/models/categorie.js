...
const categorie={
    ...
    addEventCategorie:(idEvent, categorie, callback) => {
        let id = idEvent + categorie.idCategorie;
        return db.query("INSERT INTO `gout`.`categorie` (`id`, `id_event`,`id_data_categorie`) VALUES (?,?,?)",[id, idEvent, categorie.idCategorie], callback);
    },
